...
Tetris.prototype.init = function(){
    ...
    ***************/
    ...
    this.interval = setInterval(this.Animate_Shape.bind(this), 1000);
}
...
Tetris.prototype.do_move = function(direction) {
	...
	// mugitu behar dugu pieza. Gogoratu Tetris.DIRECTION array-ak norabide 
...
Tetris.prototype.do_rotate = function(){
	...
	if(this.current_shape.shift_rotation_dir)
	    this.current_shape.rotation_dir *= -1
};
